...
public class InboundFileDiningIntegrationTests {
	...
	// TODO 31: Comment out the @SpringApplicationConfiguration above, and uncomment the
	//	alternate @SpringApplicationConfiguration which imports the XML configurations.  
	//	Then same as #11...
	...
	public static class TestConfiguration {
		...
		//		TODO 12:	Add an inbound File Channel Adapter.
			...
			return IntegrationFlows
				.from( 
					Files.inboundAdapter(
						new FileSystemResource("src/test/resources/rewards/messaging").getFile())
						.patternFilter("dining*.xml")
						.preventDuplicates()
						.get()	 )
				.channel("mixedXmlDinings")
				.get();
		}
	}	
