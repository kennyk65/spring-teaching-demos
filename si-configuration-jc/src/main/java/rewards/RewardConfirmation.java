...
public class RewardConfirmation implements Serializable {
	...
	public RewardConfirmation(String confirmationNumber, String diningTransactionId,
		...
		Assert.hasText(confirmationNumber, "'confirmationNumber' must contain text");
		Assert.hasText(diningTransactionId, "'diningTransactionId' must contain text");
	...
	@Override
	public int hashCode() {
		return 13 * diningTransactionId.hashCode() + confirmationNumber.hashCode();
	}
	...
	public boolean equals(Object o) {
		...
		return diningTransactionId.equals(other.diningTransactionId)
