...
public class BatchedDiningSplitterIntegrationTests {
	...
	public void inboundMultipleDiningXml() throws Exception {
		...
		// TODO 26: Comment out the empty @SpringApplicationConfiguration above, 
		//	and uncomment the @SpringApplicationConfiguration which imports the XML configuration.  
		//	Then same as #06...
